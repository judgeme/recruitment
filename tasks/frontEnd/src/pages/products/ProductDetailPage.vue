...
<template>
  <div class="bg-fairy flex items-center justify-center">
    <app-activity-loader :loading="loading">
      <div
        class="max-w-screen-xl mx-auto px-6 pt-6 lg:pt-20 xl:pt-25 pb-[92px] lg:pb-32 xl:pb-40 flex flex-col lg:flex-row justify-between lg:items-center gap-10 lg:gap-20 xl:gap-40"
      >
        <figure class="w-full lg:w-100 xl:w-[530px] h-100 xl:h-[530px] overflow-hidden">
          <img
        ...
        <div class="flex-1">
          ...
          <p class="text-primary text-lg mb-8 xl:mb-15">
            <bdi>
              <span>$</span>
              {{ product?.price }}
            </bdi>
